...
LDFLAGS="github.com/POTION4/cloud-print-connector/lib.BuildDate=$CONNECTOR_VERSION"
CONNECTOR_DIR=$GOPATH/src/github.com/POTION4/cloud-print-connector
...
echo "Running go get..."
go get -ldflags -X="$LDFLAGS" -v github.com/POTION4/cloud-print-connector/...
rc=$?
if [[ $rc != 0 ]]; then
